...
//                fragment.setArguments(args);
                Fragment fragment = new MyImgActivity();
                return fragment;
...
//            dummyTextView.setText(Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public static class MyImgActivity extends Fragment{
        public MyImgActivity(){
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.listxml, container, false);
            ImageView myview = (ImageView) rootView.findViewById(R.id.img_buzz);

            myview.setImageResource(R.drawable.scenery);
            return rootView;
        }
    }
    WebView heroespage;
